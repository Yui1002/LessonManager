...
const PastClass = (props) => {
  ...
  useEffect(() => {
    props.checkLogin(getPastClasses);
  }, [month, year]);
        ...
        <div>
          ...
          <FormControl variant="standard" sx={{ m: 1, minWidth: 120 }}>
            ...
            <Select
              ...
              label="month"
            >
              <MenuItem value={moment().format("YYYY") - 5}>
                {moment().format("YYYY") - 5}
              </MenuItem>
              <MenuItem value={moment().format("YYYY") - 4}>
                {moment().format("YYYY") - 4}
              </MenuItem>
              <MenuItem value={moment().format("YYYY") - 3}>
                {moment().format("YYYY") - 3}
              </MenuItem>
              <MenuItem value={moment().format("YYYY") - 2}>
                {moment().format("YYYY") - 2}
              </MenuItem>
              <MenuItem value={moment().format("YYYY") - 1}>
